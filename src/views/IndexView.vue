    ...
    <el-row>
      ...
      <el-col :span="6">
        <div class="col-content-right">
          <el-form ref="formRef" :label-position="'top'" :model="formModel" :rules="formRules">
          ...
          <div v-for="(item, index) in formList" :key="index">
            <el-form
              ...
              :rules="item.rules"
            >
              <el-form-item v-for="(iv, inIndex) in item.itemList" :key="inIndex" :label="iv.label">
                ...
                <div class="add-server-select" v-if="iv.value.indexOf('server') !== -1">
                  ...
                  <el-icon
                    ...
                    ><CirclePlus
                  /></el-icon>
                  <el-icon class="add-server-icon" v-else @click="delServer(item.id, iv.id)"
                    ><Delete
                  /></el-icon>
                </div>
                <el-select
              ...
              <el-row :gutter="24">
                ...
                <el-col :span="12">
                  <div class="back-btn-col-del">
                    <el-icon class="add-server-icon" @click="delType(item.id)"><Delete /></el-icon>
                  </div>
                </el-col>
              </el-row>
            </div>
